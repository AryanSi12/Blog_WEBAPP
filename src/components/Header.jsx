        ...
        <div className="-my-6 divide-y divide-gray-500/10">
            ...
            {nav.map((item) =>
              item.active ? (
                <NavLink
                  ...
                  to={item.slug}
                  className={({isActive}) => 
                    `block font-medium text-xl px-4 py-2 rounded-md transition duration-200 
                    ${isActive ? "text-teal-500 bg-teal-100" : "text-slate-700"} 
          ...
          <div className="py-6">
            {authStatus ? (
              ...
              <Link 
                to="/Login" 
                className="ml-6 text-lg font-semibold leading-6 text-teal-700 hover:text-gray-700 transition duration-200"
                onClick={() => setMenuOpen(false)}
              >
                Log in <span aria-hidden="true">&rarr;</span>
              </Link>
